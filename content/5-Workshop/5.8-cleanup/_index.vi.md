...
Bạn đã hoàn thành **Workshop FlashLearn trên AWS**!
...
>  **Bước tiếp theo**: Tìm hiểu cách thêm **CloudFront CDN** để tăng tốc độ tải ảnh, hoặc **Application Load Balancer** để mở rộng theo chiều ngang (Horizontal Scaling).
